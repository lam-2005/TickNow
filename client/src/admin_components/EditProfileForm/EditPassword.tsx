...
const EditPassword = ({ Info }: { Info: UserType }) => {
    ...
    return (
        <div className="flex-column gap-5">
                        ...
                        <div className='relative flex-column gap-2 w-full '>
                            <div className='relative w-full'>
                                <input
                                    ...
                                    className={`border peer w-full border-gray-300 rounded-md p-2 mt-1 outline-none focus:border-primary  ${touched.password && errors.password
                        ...
                        <div className='relative flex-column gap-2 w-full' >
                            <div className='relative w-full'>
                                <input
                                    ...
                                    className={`border w-full border-gray-300 rounded-md p-2  mt-1 outline-none focus:border-primary ${touched.password && errors.password
                                        ? "border-red-500 focus:border-red-500"
                                        : "border-gray-300 focus:border-primary"
                                        }`}
                        ...
                        <div className='relative flex-column gap-2 w-full'>
                            <div className='relative w-full '>
                                <input
                                    ...
                                    className={`border w-full border-gray-300 rounded-md p-2  mt-1 outline-none focus:border-primary ${touched.confirmPassword && errors.confirmPassword
                                        ? "border-red-500 focus:border-red-500"
                                        : "border-gray-300 focus:border-primary"
                                        }`}
            ...
            <button
                disabled={errors.password || errors.newPassword || errors.confirmPassword || !formdata.password || !formdata.confirmPassword || !formdata.newPassword ? true : false}
                className="btn self-start disabled:brightness-50 disabled:cursor-not-allowed" onClick={handleEditPass}>Đổi mật khẩu</button>
        </div>
    )
}
