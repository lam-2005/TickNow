...
const EditProfile = ({ Info, tokenAdmin }: { Info: UserType, tokenAdmin: string }) => {
        ...
        <div className="flex-column gap-5">
            <div className="space-y-2.5">
                ...
                <div className="flex text-lg items-start">
                    ...
                    {isEditing ? (
                        <div className='flex-column flex-9/10  gap-2'>
                            <input onBlur={touchedFullName} name='name'
                                value={formData.name}
                                onChange={handleChange} ref={focusRef}
                                className={`border border-gray-300 rounded-md p-2  mt-1 outline-none focus:border-primary ${touched.name && errors.name
                ...
                <div className="flex text-lg items-center">
                    ...
                    {isEditing ? (
                        <div className='flex-column flex-9/10  gap-2'>
                            <input onBlur={touchedPhone} name='phone' value={formData.phone} onChange={handleChange}
                                className={`border border-gray-300 rounded-md p-2  mt-1 outline-none focus:border-primary ${touched.phone && errors.phone
                                    ? "border-red-500 focus:border-red-500"
                                    : "border-gray-300 focus:border-primary"
                                    }`}
                ...
                <div className="flex text-lg items-center">
                    ...
                    {isEditing ? (
                        ...
                        <div className='flex-column flex-9/10  gap-2'>
                            <input onBlur={touchedDateOfBirth} name='year' value={formData.year} onChange={handleChange}
                                className={`border border-gray-300 rounded-md p-2  mt-1  flex-9/10 outline-none focus:border-primary w-fit self-start ${touched.year && errors.year
                                    ? "border-red-500 focus:border-red-500"
                                    : "border-gray-300 focus:border-primary"
                                    }`}
            ...
            {isEditing ? (
                <div className='flex gap-5 '>
                    ...
                    <button className="btn  bg-error " onClick={() => setIsEditing(false)}>
                        Hủy
                    </button>
                </div>
            ) : (
